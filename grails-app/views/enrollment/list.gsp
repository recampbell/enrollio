                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="status" title="${message(code: 'enrollment.status.label', default: 'Status')}" />
                        
                            <th><g:message code="enrollment.student.label" default="Student" /></th>
                   	    
                            <th><g:message code="enrollment.classSession.label" default="Class Session" /></th>
                    ...
                    <g:each in="${enrollmentInstanceList}" status="i" var="enrollmentInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: enrollmentInstance, field: "status")}</td>
                        
                            <td>${fieldValue(bean: enrollmentInstance, field: "student")}</td>
                        
                            <td>${fieldValue(bean: enrollmentInstance, field: "classSession")}</td>
